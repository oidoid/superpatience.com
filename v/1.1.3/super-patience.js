...
(function(NumUtil) {
    ...
    NumUtil.ceilMultiple = ceilMultiple;
...
class NumXY {
    ...
    construct(xXY, y) {
        return new NumXY(xXY, y);
    }
    constructClamp(xXY, y) {
        return NumXY.clamp(xXY, y);
    }
    copy() {
...
class I16XY {
    ...
    static clamp(xXY, y) {
        return new this(I16.clamp(typeof xXY === 'number' ? xXY : xXY.x), I16.clamp(typeof xXY === 'number' ? y : xXY.y));
    }
    static floor(xXY, y) {
    ...
    construct(xXY, y) {
        return new I16XY(xXY, y);
    }
    constructCeil(xXY, y) {
        return I16XY.ceil(xXY, y);
    }
    constructClamp(xXY, y) {
        return I16XY.clamp(xXY, y);
    }
    constructFloor(xXY, y) {
        return I16XY.floor(xXY, y);
    }
    constructRound(xXY, y) {
        return I16XY.round(xXY, y);
    }
    copy() {
    ...
    dotClamp(xXY, y) {
        return I16.clamp(this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y));
    }
    dotNum(xXY, y) {
        return this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y);
    }
...
class NumBox {
    ...
    construct(xXYBox, yWH, w, h) {
        return new NumBox(xXYBox, yWH, w, h);
    }
    constructClamp(xXYBox, yWH, w, h) {
        return NumBox.clamp(xXYBox, yWH, w, h);
    }
...
class I16Box {
    ...
    construct(xXYBox, yWH, w, h) {
        return new I16Box(xXYBox, yWH, w, h);
    }
    constructCeil(xXYBox, yWH, w, h) {
        return I16Box.ceil(xXYBox, yWH, w, h);
    }
    constructClamp(xXYBox, yWH, w, h) {
        return I16Box.clamp(xXYBox, yWH, w, h);
    }
    constructFloor(xXYBox, yWH, w, h) {
        return I16Box.floor(xXYBox, yWH, w, h);
    }
    constructRound(xXYBox, yWH, w, h) {
        return I16Box.round(xXYBox, yWH, w, h);
    }
    contains(xXYBox, yWH, w, h) {
        if (this.empty) return false;
        const box = argsToBox(xXYBox, yWH, w, h);
    ...
    copy() {
        return new I16Box(this.x, this.y, this.w, this.h);
    }
    get empty() {
        return this.areaNum === 0;
    }
...
class I4XY {
    ...
    static clamp(xXY, y) {
        return new this(I4.clamp(typeof xXY === 'number' ? xXY : xXY.x), I4.clamp(typeof xXY === 'number' ? y : xXY.y));
    }
    static floor(xXY, y) {
    ...
    construct(xXY, y) {
        return new I4XY(xXY, y);
    }
    constructCeil(xXY, y) {
        return I4XY.ceil(xXY, y);
    }
    constructClamp(xXY, y) {
        return I4XY.clamp(xXY, y);
    }
    constructFloor(xXY, y) {
        return I4XY.floor(xXY, y);
    }
    constructRound(xXY, y) {
        return I4XY.round(xXY, y);
    }
    copy() {
    ...
    dotClamp(xXY, y) {
        return I4.clamp(this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y));
    }
    dotNum(xXY, y) {
        return this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y);
    }
...
class U16XY {
    ...
    static clamp(xXY, y) {
        return new this(U16.clamp(typeof xXY === 'number' ? xXY : xXY.x), U16.clamp(typeof xXY === 'number' ? y : xXY.y));
    }
    static floor(xXY, y) {
    ...
    construct(xXY, y) {
        return new U16XY(xXY, y);
    }
    constructCeil(xXY, y) {
        return U16XY.ceil(xXY, y);
    }
    constructClamp(xXY, y) {
        return U16XY.clamp(xXY, y);
    }
    constructFloor(xXY, y) {
        return U16XY.floor(xXY, y);
    }
    constructRound(xXY, y) {
        return U16XY.round(xXY, y);
    }
    copy() {
    ...
    dotClamp(xXY, y) {
        return U16.clamp(this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y));
    }
    dotNum(xXY, y) {
        return this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y);
    }
...
class U16Box {
    ...
    construct(xXYBox, yWH, w, h) {
        return new U16Box(xXYBox, yWH, w, h);
    }
    constructCeil(xXYBox, yWH, w, h) {
        return U16Box.ceil(xXYBox, yWH, w, h);
    }
    constructClamp(xXYBox, yWH, w, h) {
        return U16Box.clamp(xXYBox, yWH, w, h);
    }
    constructFloor(xXYBox, yWH, w, h) {
        return U16Box.floor(xXYBox, yWH, w, h);
    }
    constructRound(xXYBox, yWH, w, h) {
        return U16Box.round(xXYBox, yWH, w, h);
    }
    contains(xXYBox, yWH, w, h) {
        if (this.empty) return false;
        const box = argsToBox(xXYBox, yWH, w, h);
    ...
    copy() {
        return new U16Box(this.x, this.y, this.w, this.h);
    }
    get empty() {
        return this.areaNum === 0;
    }
...
class UintXY {
    ...
    static clamp(xXY, y) {
        return new this(Uint.clamp(typeof xXY === 'number' ? xXY : xXY.x), Uint.clamp(typeof xXY === 'number' ? y : xXY.y));
    }
    static floor(xXY, y) {
    ...
    construct(xXY, y) {
        return new UintXY(xXY, y);
    }
    constructCeil(xXY, y) {
        return UintXY.ceil(xXY, y);
    }
    constructClamp(xXY, y) {
        return UintXY.clamp(xXY, y);
    }
    constructFloor(xXY, y) {
        return UintXY.floor(xXY, y);
    }
    constructRound(xXY, y) {
        return UintXY.round(xXY, y);
    }
    copy() {
    ...
    dotClamp(xXY, y) {
        return Uint.clamp(this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y));
    }
    dotNum(xXY, y) {
        return this.#x * (typeof xXY === 'number' ? xXY : xXY.x) + this.#y * (typeof xXY === 'number' ? y : xXY.y);
    }
    ...
    maxClamp(xXY, y) {
        this.#x = Uint.clamp(Math.max(this.#x, typeof xXY === 'number' ? xXY : xXY.x));
    ...
    minClamp(xXY, y) {
        this.#x = Uint.clamp(Math.min(this.#x, typeof xXY === 'number' ? xXY : xXY.x));
...
function Immutable1(val) {
    if (val == null || typeof val != 'object') return val;
    for (const subVal of Object.values(val))Immutable1(subVal);
    return Object.freeze(val);
}
class Animator {
    #film;
...
class FollowCamSystem {
    ...
    runEnt(ent, game) {
        ...
        sprite.bounds.sizeTo(I16(followCam.fill === 'X' || followCam.fill === 'XY' ? game.cam.viewport.w - pad.x * 2 : sprite.w), I16(followCam.fill === 'Y' || followCam.fill === 'XY' ? game.cam.viewport.h - pad.y * 2 : sprite.h));
        sprite.bounds.moveTo(computeX(sprite, game.cam, followCam), computeY(sprite, game.cam, followCam));
    }
}
...
const query1 = 'followPoint & sprite';
...
(function(Button1) {
    ...
    function toBits(...buttons) {
        return buttons.reduce((sum, button)=>Uint(sum | Button.Bit[button]), Uint(0));
    }
...
(function(Viewport) {
    ...
    function clientViewportWH(window1) {
        return new NumXY(window1.innerWidth, window1.innerHeight);
    }
    ...
    function toLevelXY(point, clientViewportWH, cam) {
        return I16XY.clamp(cam.x + point.x / clientViewportWH.x * cam.w, cam.y + point.y / clientViewportWH.y * cam.h);
    }
...
const WrapXMask = U16(0b1111);
const WrapYMask = U16(0b1111);
const LayerMask = U16(0b111_1111);
const LayerByHeightFlag = U16(0b1);
const LayerByOriginFlag = U16(0b0);
const LayerByHeightMask = U16(0b1);
...
class Sprite {
    ...
    moveCenterToClamp(xXY, y) {
        this.bounds.moveCenterToClamp(xXY, y);
        return this;
    }
    order() {
        this.#bounds.order();
...
class Text {
    ...
    render(filmByID, layer) {
        ...
        for (const [i, __char] of layout.chars.entries()){
            ...
            const sprite = new Sprite(filmByID[filmID], layer, this.#bounds.xy.copy().addClamp(__char.xy));
            sprites.push(sprite);
        }
        this.#rendered = true;
        return sprites;
...
class ECS {
    ...
    *query(query) {
    ...
    #queryEnt(ent2, query2) {
        return query2.some((keys)=>[
                ...keys
    ...
    #removeEntImmediately(ent3) {
        ...
        for(const key in ent3)this.#entByComponent.delete(ent3[key]);
        this.#ents.delete(ent3);
    }
    #systemEnts(system) {
        return this.#entsByQuery[system.query];
    }
    *#uncachedQuery(query11) {
        const querySet = parseQuerySet(query11);
        for (const ent of this.#ents){
            if (this.#queryEnt(ent, querySet)) yield ent;
        }
    }
}
const query3 = 'cursor & sprite';
const query4 = 'sprite | sprites';
class Cam {
    ...
    resize() {
        ...
        this.nativeViewportWH.set(Viewport.nativeViewportWH(this.#window, this.clientViewportWH));
        this.#scale = Viewport.scale(this.nativeViewportWH, this.minViewport, I16(0));
...
class PointerPoller {
    ...
    #onPointEvent = (ev)=>{
        ...
        if (this.#locked) {
            this.#clientXY.addClamp(ev.movementX, ev.movementY).maxClamp(0, 0).minClamp(window.innerWidth, window.innerHeight);
        ...
        this.#xy = Viewport.toLevelXY(this.#clientXY, this.#cam.clientViewportWH, this.#cam.viewport);
...
class InputPoller {
    ...
    get sample() {
        return Uint(this.#gamepad.sample | this.#keyboard.sample | this.#pointer.sample);
    }
    get xy() {
...
class Input {
    ...
    preupdate() {
        ...
        if (this.#duration > this.#maxInterval && (this.buttons === Uint(0) || this.buttons !== this.#prevButtons)) {
            this.#duration = 0;
            this.#combo.length = 0;
...
class Renderer {
    static new(canvas, atlas, layout, atlasMeta) {
    ...
    render(_time, cam, bitmaps) {
        ...
        GL.bufferData(this.#gl, this.#perInstanceBuffer, bitmaps.buffer, this.#gl.DYNAMIC_READ);
    ...
    #resize(cam) {
        ...
        if (this.#gl.canvas.width !== nativeCanvasWH.x || this.#gl.canvas.height !== nativeCanvasWH.y) {
        ...
        this.#gl.uniformMatrix4fv(GL.uniformLocation(this.#layout, this.#uniforms, 'uProjection'), false, this.#projection);
    }
}
class RendererStateMachine {
    ...
    constructor(props){
        ...
        this.#renderer = Renderer.new(this.#canvas, this.#assets.atlas, this.#assets.shaderLayout, this.#assets.atlasMeta);
...
class CursorSystem {
    ...
    runEnt(ent, game) {
        ...
        if (game.input.xy != null || game.input.isAnyOnStart('Left', 'Right', 'Up', 'Down')) setLayer(ent.sprite, game);
    }
}
...
function reduceGamepads(sum, pad) {
    ...
    const directionsButtons = pad?.buttons.reduce(reduceButtons, Uint(0)) ?? Uint(0);
...
function pointerButtonsToButton(buttons) {
    ...
    for(let button = 1; button <= buttons; button <<= 1){
        ...
        if (fn == null) continue;
        mapped = Uint(mapped | Button.Bit[fn]);
    }
    return mapped;
}
...
function parseWrapLayerByHeightLayer(wrapLayerByHeightLayer) {
    const wrapX = wrapLayerByHeightLayer >> 12 & WrapXMask;
    const wrapY = wrapLayerByHeightLayer >> 8 & WrapYMask;
    const layerByHeight = wrapLayerByHeightLayer >> 7 & LayerByHeightMask;
    const layer = U8(wrapLayerByHeightLayer >> 0 & LayerMask);
    return {
...
function serializeWrapLayerByHeightLayer(wrapXY, layerByHeight, layer) {
    const wrap = (wrapXY.x & WrapXMask) << 12 | (wrapXY.y & WrapYMask) << 8;
    const layerByHeightFlag = layerByHeight ? LayerByHeightFlag : LayerByOriginFlag;
    return U16(wrap | layerByHeightFlag << 7 | (layer & LayerMask) << 0);
}
...
var SPAssets;
const query5 = 'card & sprite';
const query6 = 'patienceTheDemon & sprite';
const query7 = 'pile & sprite';
const query8 = 'tally & sprite';
const query9 = 'vacantStock & sprite';
function* newLevelComponents(factory, font, solitaire) {
    ...
    yield* SPLevelParser.parse(factory, font, __default6);
}
class SpriteFactory {
    #filmByID;
    layerByID = SPLayer;
...
class CardSystem {
    ...
    run(ents, game) {
        ...
        const isStockPick = picked?.sprite.intersectsSprite(this.#vacantStock, game.time);
        ...
        if (game.solitaire.selected != null && game.input.isOffStart('Action')) {
            if (this.#selected.length === 0) {
                ...
                if (drop != null && game.solitaire.selected != null && drop.pile.type !== 'Waste') Solitaire.build(game.solitaire, drop.pile);
    ...
    #drop(update) {
        ...
        for (const ent of this.#piles){
            ...
            if (overlap.flipped || overlap.empty || ent.pile.type === 'Waste' || !Solitaire.isBuildable(update.solitaire, ent.pile)) continue;
            if (drop == null || overlap.areaNum > drop.area) {
                drop = {
                    area: overlap.areaNum,
                    ent
                };
            }
        }
...
class PileHitboxSystem {
    ...
    runEnt(ent, game) {
        ...
        const xy = pile.type === 'Waste' ? sprite.bounds.xy.copy().addClamp(8 - 1, 8 - 1) : pile.type === 'Tableau' ? getTableauCardXY(game.filmByID, pile.x, Uint(0)) : getFoundationCardXY(game.filmByID, pile.suit);
        sprite.bounds.moveToClamp(xy.x - 8 + 1, xy.y - 8 + 1);
        sprite.bounds.sizeToClamp(cardWH.x + 8 * 2 - 1, cardWH.y + (pile.type === 'Waste' ? (game.solitaire.waste.length > 0 ? game.solitaire.drawSize - 1 : 0) * 8 : pile.type === 'Tableau' ? Math.max(0, game.solitaire.tableau[pile.x].length - 1) * 8 : 0) + 8 * 2 - 1);
    }
}
...
class PatienceTheDemonSystem {
    ...
    run(ents, game) {
        if (game.pickHandled || !game.input.isOffStart('Action')) return;
        for (const ent of ents){
            if (ent.sprite.intersectsSprite(game.cursor, game.time)) {
                game.pickHandled = true;
                ent.sprite.animate(game.time, nextFilm(game, ent.sprite));
            } else if (ent.sprite.intersectsBounds(game.cursor)) {
                game.pickHandled = true;
...
function SuperPatience(window1, assets) {
    ...
    ecs.patch();
    ecs.addSystem(new FollowCamSystem(), new CursorSystem(), new FollowPointSystem(), new CardSystem([
        ...ecs.query('pile & sprite')
    ], ecs.queryOne('vacantStock & sprite').sprite), new PileHitboxSystem(), new VacantStockSystem(), new PatienceTheDemonSystem(), new TallySystem(), new RenderSystem(assets.shaderLayout));
    const cam = new Cam(new U16XY(256, 214), window1);
    const self = {
        assets,
        cam,
        canvas,
...
function moveEntsToCursor(game, selected) {
    for (const pick of selected){
        pick.ent.sprite?.bounds.moveToClamp(game.cursor.bounds.xy.copy().sub(pick.offset));
    }
}
...
(function(SuperPatience1) {
    async function make(window1) {
        return SuperPatience(window1, await SPAssets.load());
    }
